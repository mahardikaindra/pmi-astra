    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center pt-24">
        <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">View Shift</h1>

          <div className="space-y-4">
            <div>
              <p className="text-sm text-gray-500">Nama Shift</p>
          ...
          <div className="mt-8 flex justify-end">
            <button
              onClick={() => router.push(`/management/shift/${id}/edit`)}
...
const ViewShiftPage = dynamic(() => Promise.resolve(PageComponent), {
  ssr: false,
});
