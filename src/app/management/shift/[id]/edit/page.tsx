...
function PageComponent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const docRef = doc(db, "artifacts", "Ij8HEOktiALS0zjKB3ay", "shift", id);
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center pt-24">
        <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">Edit Shift</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Masukkan deskripsi shift"
                className="text-sm text-gray-700 border border-gray-300 rounded-lg px-3 py-2"
              />
            </div>
            ...
            >
              {submitting ? "Updating..." : "Update Shift"}
            </button>
          </form>
        </div>
      </div>
...
const EditShiftPage = dynamic(() => Promise.resolve(PageComponent), {
  ssr: false,
});
